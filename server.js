            ...
            <div class="container">
                ...
                <div flex row class="info-section">
                    ...
                    <div flex column class="info-group">
                        ...
                        <div class="info-value">${ticket.ticket_type === 'couple' ? 'Couple (2x)' : ticket.ticket_type === 'single' ? 'Single (1x)' : ticket.ticket_type === 'three' ? 'Three People' : ticket.ticket_type}</div>
                    </div>
                </div>
